...
//                long time = properties.getLong("time"); // get long value of millisecond of time
//                String url = properties.getString("url"); // extract the url from the properties
//
...
//    }
     ...
     */
    // This method is to tie all the steps together, creating a URL, sending the request, processing the response.
...
//        // Slow by 2 seconds to show the loading indicator
//        try {
//            Thread.sleep(2000);
